[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-2e0aaae1b6195c2367325f4f02e2d04e9abb55f0b24a779b69b11b9e10269abc.svg)](https://classroom.github.com/online_ide?assignment_repo_id=22978304&assignment_repo_type=AssignmentRepo)
...
1. Desenvolva algoritmos recursivos para os seguintes problemas e implemente-os (em Java, por exemplo):
   1. OK Multiplicação de dois números naturais, através de somas sucessivas (Ex.: 6 ∗ 4 = 4 + 4 + 4 + 4 + 4 + 4).
   2. OK Soma de dois números naturais, através de incrementos sucessivos (Ex.: 3 + 2 = + + (+ + + 1)).
   3. OK Cálculo de 1 + 1/2 + 1/3 + 1/4 + ... + 1/N.
   4. OK Inversão de uma string.
...
do vetor.
   8. OK Verifique se uma palavra é palíndromo (Ex. aba, abcba, xyzzyx).
